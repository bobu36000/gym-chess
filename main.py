...
# agent = DQN(env, epoch, lr, discount, epsilon, target_update=100, channels=(24,48,96), layer_dims=[128,128,128], kernel_size=3, stride=1, batch_size=100, memory_size=10000)
...
# agent.load_parameters('2024-04-02_14-37-20, 100 epochs', 'model.pth')
